---
wiki_id: SRC-WQ-GS-178
type: source_summary
title: "GS-178 强化例题8.7"
subject: "高等数学"
source_role: formal_wrong_card
source_refs:
  - "错题知识网络/错题卡/GS-178_强化例题8.7.md"
visual_detail_refs: []
visual_ids: []
wrongnet_refs:
  - "GS-178"
...
- 正式错题卡：`错题知识网络/错题卡/GS-178_强化例题8.7.md`
- wrongnet ID：`GS-178`
...
| missed_action | 缺少用户本人作答过程；待确认是否只得到严格条件而漏回查选项隐含口径 |
| related_method_card_id | H08-005 |
| next_reminder | 含选项的反常积分要先求严格数学条件，再判断题目是否带有“确为反常”的隐含限制。 |
