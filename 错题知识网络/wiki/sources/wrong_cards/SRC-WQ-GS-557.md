---
wiki_id: SRC-WQ-GS-557
type: source_summary
title: GS-557 138822 余弦二阶小量判敛
subject: 高等数学
source_role: formal_wrong_card
source_refs:
- 错题知识网络/错题卡/GS-557_138822余弦二阶小量判敛.md
visual_detail_refs:
...
- MATHWIKI-METHOD-CLUSTER-289_余弦等价无穷小
...
formal_projection_sha256: 060aa793420e642dc35ffed70a4fcf2be28d1a4a2cbbbd12c97f850ac6cf93cd
question_asset_refs:
...
- 正式错题卡：`错题知识网络/错题卡/GS-557_138822余弦二阶小量判敛.md`
- wrongnet ID：`GS-557`
- 角色：正式错题卡的轻量 source summary；本页是可重建投影，不替代正式卡。

## 可视化入口

- 详情页：`错题知识网络/可视化错题详情/高等数学/GS-557_138822.md`（`VIS-GS-557`）
...
- 错因字段：计算失误、符号错误、过程跳步
- 第一动作：先圈出 \(\frac{a^2}{2n^2}\) 中的 \(n^2\)，写出 \(p=2>1\)
- 个人断点：誊写时把 \(n^2\) 漏成 \(n\)，把 \(\sum\frac1{n^2}\) 误转成 \(\sum\frac1n\)
- 方法卡 ID：H16-005
- 当前强关系：暂无强边
