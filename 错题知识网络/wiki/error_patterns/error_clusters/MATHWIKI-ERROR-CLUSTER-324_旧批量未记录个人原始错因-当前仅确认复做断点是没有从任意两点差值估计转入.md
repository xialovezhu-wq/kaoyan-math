---
wiki_id: MATHWIKI-ERROR-CLUSTER-324
type: error_cluster
title: "旧批量未记录个人原始错因；当前仅确认复做断点是没有从任意两点差值估计转入单调定义法，需用户复做确认。"
subject: "高等数学"
source_refs:
  - "错题知识网络/错题卡/"
wiki_refs:
...
|---|---|---|---|---|---|---|
| GS-130 | [[SRC-WQ-GS-130]] | 高等数学 | 一元函数微分学应用 | 一元函数微分学应用；单调性与极值 | 待复做 | `错题知识网络/错题卡/GS-130_579362026.4.16.md` |
