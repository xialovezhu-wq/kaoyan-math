---
wiki_id: MATHWIKI-ERROR-CLUSTER-323
type: error_cluster
title: "旧批量未记录个人原始错因；当前仅确认复做断点是没有从 $f(x)$ 与 $f(1/x)$ 的互逆结构构造第二方程并联立消元，需用户复做确认。"
subject: "高等数学"
source_refs:
  - "错题知识网络/错题卡/"
wiki_refs:
...
|---|---|---|---|---|---|---|
| GS-122 | [[SRC-WQ-GS-122]] | 高等数学 | 函数方程与奇偶性 | 一元函数微分学应用；函数奇偶性与导数性质 | 待复做 | `错题知识网络/错题卡/GS-122_578742026.4.1.md` |
