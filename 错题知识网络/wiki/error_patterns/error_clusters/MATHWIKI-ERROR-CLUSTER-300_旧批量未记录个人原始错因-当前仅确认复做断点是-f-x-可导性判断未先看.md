---
wiki_id: MATHWIKI-ERROR-CLUSTER-300
type: error_cluster
title: "旧批量未记录个人原始错因；当前仅确认复做断点是 |f(x)| 可导性判断未先看 f(a) 是否为 0 及是否一阶穿零，需用户复做确认。"
subject: "高等数学"
source_refs:
  - "错题知识网络/错题卡/"
wiki_refs:
...
|---|---|---|---|---|---|---|
| GS-101 | [[SRC-WQ-GS-101]] | 高等数学 | 一元函数微分学应用 | 一元函数微分学应用；可导性判定；导数定义；分段函数 | 待复做 | `错题知识网络/错题卡/GS-101_1000题B组3.13.md` |
