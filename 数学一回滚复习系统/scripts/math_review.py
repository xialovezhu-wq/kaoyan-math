...
REPOSITORY = "xialovezhu-wq/kaoyan-math"
BRIDGE_INBOX = Path("/Users/xiazhibin/Documents/Study-Pro-Bridge/inbox")
BRIDGE_OUTBOX = Path("/Users/xiazhibin/Documents/Study-Pro-Bridge/outbox")
...
def record_outcome(root: Path, value: dict[str, Any], scheduler: Any) -> dict[str, Any]:
    root = root.resolve()
...
def advice_binding(root: Path, run_record_path: str, quick: Any) -> tuple[dict[str, Any], list[dict[str, Any]]]:
    ...
    if root == math_postcommit.PRODUCTION_ROOT.resolve():
        web_root = Path("/Users/xiazhibin/Documents/Study-Pro-Bridge")
    else:
        web_root = root
